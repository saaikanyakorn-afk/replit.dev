...
const SMTP_PRESETS = [
  {
    id: "resend",
    label: "Resend",
    badge: "แนะนำ · ฟรี 3,000/เดือน",
    badgeColor: "bg-orange-100 text-orange-700",
    host: "smtp.resend.com",
    port: 587,
    secure: false,
    passLabel: "API Key (จาก resend.com/api-keys)",
    passHint: "เข้า resend.com → API keys → Create API Key → copy key ที่ขึ้นต้นด้วย re_",
    signupUrl: "https://resend.com/api-keys",
    userFixed: "resend",
    fromHint: "สำหรับทดสอบ: onboarding@resend.dev · สำหรับ production: noreply@etaxerp.com",
  },
  {
    id: "brevo",
    label: "Brevo",
