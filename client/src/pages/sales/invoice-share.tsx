...
import { isAndroid, isIOS, isLineAndroid, isLineIOS, redirectToChrome } from "@/lib/line-android-redirect";

export default function InvoiceShare() {
  const { token } = useParams<{ token: string }>();
  const [docNo, setDocNo] = useState("ใบแจ้งหนี้");
  ...
  const directPdfUrl = `/api/share/invoice/${token}/pdf`;
