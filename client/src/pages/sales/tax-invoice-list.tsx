                      ...
                      <Fragment key={inv.id}>
                        <TableRow data-testid={`row-tax-invoice-${inv.id}`} className={`hover:bg-slate-50/50 border-b ${selectedIds.has(inv.id) ? "bg-purple-50/50" : ""}`}>
                          ...
                          <TableCell className="pt-2.5 pb-2.5">
                            ...
                            {!inv.paymentMethod ? null : inv.pmIsCash ? (() => {
                          ...
                          <TableCell className="text-right tabular-nums pt-2.5">
                            {(() => {
                              ...
                              const isPaid = PAID_STATUSES.includes(inv.status) || inv.paymentStatus === "paid" || inv.paymentStatus === "success" || inv.pmIsCash === true;
                          ...
                          <TableCell className="text-center pt-2.5">
                            {(() => {
                              ...
                              const effectiveStatus = (inv.status === "cash" || (inv.pmIsCash === true && inv.status === "debtor"))
                                ? "cash"
